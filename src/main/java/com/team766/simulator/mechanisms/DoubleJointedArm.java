...
public class DoubleJointedArm {
	...
	private DCMotor j1Motor = DCMotor.makeNeo();
	private DCMotor j2Motor = DCMotor.makeNeo();
	...
	public void step(double dt) {
		final MechanicalAngularDevice.Output j1Drive = j1Gears.step(new MechanicalAngularDevice.Input(getJ1Velocity()));
		final MechanicalAngularDevice.Output j2Drive = j2Gears.step(new MechanicalAngularDevice.Input(getJ2Velocity()));
