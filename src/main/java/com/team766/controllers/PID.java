...
import com.team766.controllers.PIDException;
...
public class PID {
	...
	public PID(String configName, double absEncoderOffset){
			mc1 = RobotProvider.instance.getMotor(configName);
			csm1 = (CANSparkMax)mc1;
			pid1 = csm1.getPIDController();
	...
	public void setkDutyCycleAllowedClosedLoopError(double error){
