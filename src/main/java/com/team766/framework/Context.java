 ...
 * time, it has to create new Contexts for them (using the startAsync method).
 * 
 ...
 * have to explicitly indicate when other Context should be allowed to run.
...
public final class Context implements Runnable, LaunchedContext {
	...
	/// If this Context was created by another context using startAsync, this
	/// will contain a reference to that originating Context.
	 ...
	 * should be created with Context.startAsync or Scheduler.startAsync.
	 */
